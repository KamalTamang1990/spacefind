...
export class IdentityPoolWrapper{
    ...
    private initialize (){
        ...
        // method to attach all thr roles to IdentityPool
        this.attachRoles();
    }
    ...
    // build authenticated and authenticated roles
    private initializeRoles(){
        ...
        // get priveledge/ Roles to list the bucket
    ...
    private attachRoles(){
        new CfnIdentityPoolRoleAttachment(this.scope, 'RolesAttachment',{
            ...
            // this will allow roles to be taken from the token
            roleMappings: {
                adminsMapping: {
                    type: 'Token',
